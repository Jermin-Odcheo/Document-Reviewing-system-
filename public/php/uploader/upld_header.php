...
<head>
    ...
    <link href="../../assets/styles/header_footer.css" rel="stylesheet">
</head>
                            ...
                            <div class="input-group d-flex align-items-center">
                                ...
                                <div class="input-group-append">
                                    <button class="btn btn-outline-success btn-sm" type="submit">
                                        <img src="../../assets/img/icons/magnifying-glass.png" alt="Search" style="height:25px">
                                    </button>
                                </div>
                                <div class="user_util position-relative ms-3 d-flex align-items-center">
                                    <img src="../../assets/img/icons/profile-user.png" style="height: 30px; cursor: pointer;"
